...
function Bio() {
  return (
    <div className="flex items-center justify-evenly md:w-full">
      <div className="relative flex items-center justify-start p-12 overflow-hidden shadow-inner md:h-full md:w-full bg-text/70">
        <div className="z-10 p-6 mx-2 md:w-7/12 md:h-full text-dark-2 md:ml-24">
          <h1 className="p-4 text-xl font-semibold md:text-2xl">
          ...
          <h1 className="p-4 text-xl md:text-2xl">
        ...
        <div className="absolute left-[800px] hidden p-4 md:inline md:w-5/12 rounded-2xl opacity-30  ">
          <Image
            src={bioImage}
            alt="bio image"
            width="1000"
