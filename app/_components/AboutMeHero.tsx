...
function AboutMeImage() {
  ...
  return (
    <motion.div className="relative flex flex-col w-full my-24 md:my-0 h-fit md:h-screen">
      <motion.div className="flex items-center w-full pt-24 md:pt-0 md:h-screen md:relative md:flex-col ">
        <motion.div
          initial="rest"
          whileHover="hover"
          animate="rest"
