...
const FloatingSocialBar: React.FC = () => {
  ...
  return (
    <motion.div
      initial={{
        y: isMobile ? 80 : -80,
        rotateX: isMobile ? 90 : -90,
        opacity: 0,
      }}
      animate={{
        y: hasAnimated ? 0 : isMobile ? 80 : -80,
        rotateX: hasAnimated ? 0 : isMobile ? 90 : -90,
      ...
      className="fixed bottom-0 left-6 scale-x-[-1] origin-bottom md:top-0 md:right-6 md:bottom-auto md:left-auto md:scale-x-100 md:origin-top z-[998]"
      style={{
    ...
    >
      ...
      <div
        className="relative bg-dark border border-stone-700/50 shadow-2xl md:rounded-b-xl md:rounded-t-none rounded-t-xl"
        style={{
          boxShadow:
