    ...
    <>
      <AnimatePresence mode="wait">
        <motion.div
          ...
          className="self-center flex justify-around fixed items-center w-full my-10 z-[999]"
        >
          <div
            ref={scope}
                ...
                >
                  {inViewComponentId === route.id ? (
                    <motion.div
                      ...
                      className={
                        "absolute self-center w-full border-b-[2px] bottom-0 border-accent"
                      }
                    ></motion.div>
                  ) : null}
                  <motion.div
